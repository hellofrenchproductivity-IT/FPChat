        ...
        <PromptInputFooter className="px-3 pb-3">
          <PromptInputTools>
            <AttachmentsButton
              ...
              status={status}
            />
            {/* Sélecteur de modèle retiré : le modèle est verrouillé côté serveur
                (cf. app/(chat)/api/chat/route.ts) — pas la peine d'afficher un choix
                qui ne changerait rien à ce qui est réellement utilisé. */}
          </PromptInputTools>
